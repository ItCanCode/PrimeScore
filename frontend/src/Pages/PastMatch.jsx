...
const LiveApi = () => {
  ...
  const selected_league_2 = location.state?.selected_league || "Epl";
  ...
  const fetchMatches = useCallback(async () => {
    ...
    try {
      const response = await fetch(apiUrl, { signal: abortController.current.signal });
      ...
      // 🔥 Filtering Logic (from old version)
